...
// ObservationStationGeoJson struct for ObservationStationGeoJson
...
func NewObservationStationGeoJson(type_ string, geometry NullableGeoJsonGeometry, properties ObservationStation) *ObservationStationGeoJson {
	this := ObservationStationGeoJson{}
	this.Type = type_
...
func (o ObservationStationGeoJson) MarshalJSON() ([]byte, error) {
...
type NullableObservationStationGeoJson struct {
	value *ObservationStationGeoJson
	isSet bool
}

func (v NullableObservationStationGeoJson) Get() *ObservationStationGeoJson {
	return v.value
}

func (v *NullableObservationStationGeoJson) Set(val *ObservationStationGeoJson) {
	v.value = val
	v.isSet = true
}

func (v NullableObservationStationGeoJson) IsSet() bool {
	return v.isSet
}

func (v *NullableObservationStationGeoJson) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObservationStationGeoJson(val *ObservationStationGeoJson) *NullableObservationStationGeoJson {
	return &NullableObservationStationGeoJson{value: val, isSet: true}
}

func (v NullableObservationStationGeoJson) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObservationStationGeoJson) UnmarshalJSON(src []byte) error {
	v.isSet = true
