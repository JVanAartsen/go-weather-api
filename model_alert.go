...
type Alert struct {
	...
	Parameters *map[string]Array `json:"parameters,omitempty"`
}
...
func (o *Alert) GetInstruction() string {
	if o == nil || o.Instruction.Get() == nil {
		var ret string
		return ret
	}
...
// SetParameters gets a reference to the given map[string]Array and assigns it to the Parameters field.
